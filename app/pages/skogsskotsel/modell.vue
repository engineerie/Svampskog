    ...
    <client-only>
      <div class="transition-all duration-300">
        <!-- <MySlideover v-model="showSlideover" :pinned="isPinned" @update:pinned="(val) => (isPinned = val)">
          ...
          <template #header>
            <UTabs v-model="selectedIndex" :items="tabItems" class="w-full" v-if="isFrameworkCompareMode" />
          </template>
  ...
  <div class="flex gap-6">
    <div class="w-[336px]">
      <h1 size="3xl" weight="thin" lead="snug" class="mb-2">
        {{ selectedTabKey === "framework1" ? currentFramework?.label : currentFramework2?.label }}
      </h1>
      <NuxtImg :src="selectedTabKey === 'framework1'
                  ? frameworkImage
                  : frameworkImage2
                  " alt="Framework image" class="rounded-lg mb-4" width="500" height="320" format="webp" />
      ...
      <FullFrameworkTimeline :frameworkValue="selectedTabKey === 'framework1'
        ...
        <div class="pt-2">
          ...
          <div class="flex">
            ...
            <div class="w-full">
              <div class="flex gap-2 items-center justify-between mx-1">
                <div class="flex gap-3 items-center">
                  <UPopover v-model:open="open" :popper="{ placement: 'bottom-start' }">
                    <UBadge size="lg" variant="solid" class="h-fit" color="neutral">{{ currentStartskog.label }}
                    </UBadge>
                ...
                <!-- <UButton icon="i-heroicons-document-text" @click="openSlideover" color="gray" variant="solid"
                class="mb-1 mt-2" :ui="{
                  rounded: 'rounded-lg',
                  color: {
                    gray: {
              ...
              <div ref="resizableContainer" class="relative w-full overflow-visible flex p-1 pt-0 rounded-lg"
                ...
                <div class="relative w-full ">
                  ...
                  <div v-if="chartVisible"
                    ...
                    <div class="grid grid-cols-2 gap-8">
                      ...
                      <div class="px-2">
                        ...
                        <LineChartForestry species="rödlistade + signalarter"
                          :selectedFramework="currentFramework.value" :selectedStartskog="currentStartskog.value"
                          :isComparison="isFrameworkCompareMode" :secondFramework="currentFramework2.value"
                          :chartType="chartType" />
                      </div>
                    </div>
                  ...
                  <div class="absolute p-2 z-10">
                    ...
                    <!-- <div class="p-2">
                    <label for="overlayOpacity">Tree Layer Opacity:</label>
                    <input id="overlayOpacity" type="range" min="0" max="1" step="0.01"
                      v-model.number="overlayOpacityValue" />
                    <span>{{ overlayOpacityValue }}</span>
                  </div> -->
                  ...
                  <div v-if="!isCompare && !isFrameworkCompareMode"
                    ...
                    <!-- <OpenSeadragonViewer ref="singleViewerRef" :dziUrl="currentImagePath.replace('.png', '.dzi')"
                    :allowPan="true" :annotations="filteredAnnotations" :selectedAnnotation="selectedAnnotation"
                    @annotationClicked="handleAnnotationClicked" class="w-full h-full" /> -->
                  ...
                  <CustomImageComparisonSlider class="w-full h-full" ref="comparisonSliderRef" v-else-if="isCompare"
                    ...
                    <template #second>
                      <OpenSeadragonViewer :currentFramework="currentFramework" :currentTime="timeLabelForDataFiltering"
                        ...
                        class="w-full h-full z-0 rounded-xl border-[0.5px] border-neutral-300 dark:border-neutral-800 overflow-hidden" />
                      <OpenSeadragonViewer :currentFramework="currentFramework2"
              ...
              <TimelineInfoBox :currentFramework="currentFramework" :currentTime="timeLabelForDataFiltering"
                :currentStartskog="currentStartskog" :isCompare="isCompare"
                :isFrameworkCompareMode="isFrameworkCompareMode" :compareFramework="currentFramework2"
                :compareStartskog="currentStartskog" :compareTime="timeLabelForDataFiltering2"
                :currentTimeLabel="currentTimeLabel" @open-info="openSlideover" />

              <div class="w-64 shrink-0" v-if="!isCompare && !isFrameworkCompareMode">
                <ul>
                  <li v-for="annotation in filteredAnnotations" :key="annotation.id" class="mb-0.5">
                    <UButton :color="selectedAnnotation &&
                      selectedAnnotation.id === annotation.id
                      ...
                      " :variant="selectedAnnotation &&
                        ...
                        ? 'soft'
                        : 'solid'
                        " size="xs" class="w-full" @click="handleAnnotationClicked(annotation)">
                      <template #leading>
                        <Icon :name="annotation.icon" :class="selectedAnnotation &&
                          selectedAnnotation.id === annotation.id
                          ? 'text-green-500'
              ...
              <LineChartForestry species="matsvamp" :selectedFramework="currentFramework.value"
                :selectedStartskog="currentStartskog.value" :isComparison="isFrameworkCompareMode"
                :secondFramework="currentFramework2.value" />
