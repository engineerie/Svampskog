    ...
    <div class="px-5 pb-3 mt-4">
      ...
      <div class="-mx-1 mt-4">
        ...
        <div class="shrink-0 inline-flex m-1 align-bottom" v-if="species['Nyasvamp-boken'] === 'x'">
          <UBadge color="warning" size="xl" variant="subtle" class="">
        ...
        <div class=" shrink-0 inline-flex m-1 align-bottom" v-if="species.Giftsvamp === 'x'">
          <UBadge color="poison" size="xl" variant="subtle" class="">
        ...
        <UBadge v-if="species.KALKmark" size="xl" color="kalkmark" variant="subtle"
          class="shrink-0 inline-flex m-1 align-bottom"> Kalkmark </UBadge>
        <UBadge v-if="species.ANNANmark" size="xl" color="vanligmark" variant="subtle"
