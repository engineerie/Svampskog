<template>
  <ModelCZoom :showToolbar="false" v-model:modelValue="uiZoom" mode="ui">
                      ...
                      <CustomImageComparisonSlider class="w-full" ref="comparisonSliderRef" v-else-if="isCompare"
                        ...
                        <template #first>
                          <OpenSeadragonViewer :naturvardsarter-visible="naturvardsarterVisible"
                            :fullscreenLayout="true" :currentFramework="currentFramework" currentTime="innan"
                        ...
                        <template #second>
                          <OpenSeadragonViewer :naturvardsarter-visible="naturvardsarterVisible"
                            :fullscreenLayout="true" :currentFramework="currentFramework"
                      ...
                      <CustomImageComparisonSlider v-else-if="isFrameworkCompareMode" ref="comparisonSliderRef"
                        ...
                        <template #first>
                          ...
                          <OpenSeadragonViewer :naturvardsarter-visible="naturvardsarterVisible"
                            ...
                            :dziUrl="frameworkOverlayImagePath1.replace('.png', '.dzi')"
                            :overlayDziUrl="currentImagePath.replace('.png', '.dzi')"
                            :allowPan="!isCompare && !isFrameworkCompareMode" v-else
                        ...
                        <template #second>
                          <OpenSeadragonViewer :naturvardsarter-visible="naturvardsarterVisible"
                            :fullscreenLayout="true" :currentFramework="currentFramework2"
                            :currentTime="timeLabelForDataFiltering" :currentStartskog="currentStartskog"
                                  ...
                                  <template #content>
                                    <div class="w-full flex flex-col gap-0.5 p-1">
                                      <UButton v-for="opt in layoutTabItems" :key="opt.value"
                                        class="w-full text-white hover:bg-neutral-500/20" color="neutral"
                                        variant="ghost" :label="opt.label" @click="currentLayoutMode = opt.value" />
                                    </div>
                                  </template>
                                </UPopover>
                            ...
                            <div v-if="timeInfoVisible" class="my-4">
                              ...
                              <div>
                                ...
                                <span class="text-neutral-50"
                                  v-html="makeClickableHtml(timelineInfoBefore.svamp)"></span>
                              </div>
                            </div>
                          </div>
...
import Trakthygge from '~/pages/skogsskotsel/trakthygge.vue';
